...
<header class="header" id="inicio">
        <nav class="navbar navbar-expand-lg bg-body-tertiary barraNav">
            <div class="container-fluid">
              <a class="navbar-brand" href="<?= ROOT ?>/index.php">Login</a>
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="<?= ROOT ?>/vistas/home.php">Inicio</a>
                      </li>
                  <li class="nav-item">
                    <a class="nav-link" href="<?= ROOT ?>/modulos/listaPrecios/lista.php">Lista De Precios</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="<?= ROOT ?>/modulos/reservas/reservas.php">Reserva</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= ROOT ?>/includes/logout.php">Cerrar Sesion</a>
                  </li>
                </ul>
              </div>
            </div>
